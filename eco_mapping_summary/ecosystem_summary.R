...
eco_dat <- read_csv(here("eco_mapping_summary", "dat", "CEM-footprint.csv"), 
...
eco_dat <- read_xlsx(here("eco_mapping_summary", 
                                 "dat", 
                                 "Intersect_Footprint_20200901_CEM.xlsx")) %>% 
# Select the attributes of interest.
select(PAZ = CLASS, VEG_STATUS, CEM_ECP, Area_ha, ECO_SEC, BGC_ZONE, BGC_SUBZON, BGC_VRT,  
