...
sunrise <- read_csv("dat/sunrisesunsetFSJ.csv", skip = 1) %>% 
...
TreeCover <- read_excel("dat/TREEto2019.xlsx", "Tree") %>% 
...
## BHC and LCC ---- 
BHC_LCC <- read_excel("dat/BHCto2019.xlsx", "Habitat") %>%
...
BHClookup <- read_excel("dat/BHClookup.xlsx", "BHClookup")
